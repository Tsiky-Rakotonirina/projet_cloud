...
export const mapApi = {
  ...
  async getSignalements() {
    try {
      ...
      return [
        { id: 1, lng: 47.5161, lat: -18.8883, name: 'Route RN7 - Km 5', status: 'en_cours', images: [] },
        { id: 2, lng: 47.5250, lat: -18.8750, name: 'Carrefour Analakely', status: 'planifie', images: [] },
        { id: 3, lng: 47.4950, lat: -18.8950, name: 'Boulevard de l\'Indépendance', status: 'termine', images: [] },
        { id: 4, lng: 47.5350, lat: -18.8650, name: 'Route vers Ivato', status: 'en_cours', images: [] },
      ];
    }
  }
};
